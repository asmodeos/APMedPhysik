...
%Für die E-Mail-Adressen auf der Titelseite
\usepackage{footnpag}
...
%Kleiner Fix für psychologische Probleme mit dem Totenkreuz des 'Thanks'-Befehls
...
%Hübsche Vektorpfeile mit vv{}
\usepackage{esvect}

%Einige Abkürzungen für die Mathematik
\newcommand{\R}{\mathbb{R}}
\newcommand{\Z}{\mathbb{Z}}
\newcommand{\Q}{\mathbb{Q}}
\newcommand{\cbrt}[1]{\sqrt[3]{#1}}
\newcommand{\GNU}{{\sc{GNU}}Plot} % Sollte nicht mehr verwendet werden, besser \kap (Kapitälchen)
